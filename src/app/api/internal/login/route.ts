...
import {
  INTERNAL_AUTH_COOKIE_MAX_AGE_SECONDS,
  INTERNAL_AUTH_COOKIE_NAME,
  issueInternalAuthToken,
...
export async function POST(request: Request) {
  ...
  try {
    ...
    cookieStore.set(INTERNAL_AUTH_COOKIE_NAME, issueInternalAuthToken(), {
      httpOnly: true,
      sameSite: 'lax',
      secure: process.env.NODE_ENV === 'production',
      path: '/',
      maxAge: INTERNAL_AUTH_COOKIE_MAX_AGE_SECONDS,
    });
