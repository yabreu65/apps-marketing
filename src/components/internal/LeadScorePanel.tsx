    ...
    <section className="space-y-4 rounded-2xl border border-[#26324A] bg-[#151B2E] p-6">
      ...
      <div className="flex flex-wrap items-center gap-3">
        <div className="rounded-xl border border-[#26324A] bg-[#111827] px-4 py-3">
          ...
          <p className="text-2xl font-semibold text-slate-100">{score.score}/100</p>
        </div>
      ...
      <div className="grid gap-3 sm:grid-cols-2">
        ...
        <article className="rounded-xl border border-[#26324A] bg-[#111827] p-3">
          ...
          {score.positiveSignals.length ? (
            ...
            <p className="mt-1 text-sm text-slate-300">Sin señales positivas relevantes.</p>
          )}
        </article>
      </div>
      ...
      <article className="rounded-xl border border-[#26324A] bg-[#111827] p-3">
        ...
        {score.missingSignals.length ? (
          ...
          <p className="mt-1 text-sm text-slate-300">No se detectaron faltantes críticos en esta evaluación.</p>
        )}
      </article>

      <article className="rounded-xl border border-[#26324A] bg-[#111827] p-3">
        <p className="text-xs uppercase tracking-wide text-slate-400">Siguiente acción recomendada</p>
        <p className="mt-1 text-sm text-slate-300">{score.recommendedAction}</p>
      </article>

      <p className="text-xs text-slate-400">
        Estimación local explicable. No es una decisión automática, no cambia el estado del lead y no se persiste en base de datos.
      </p>
    </section>
  );
}
