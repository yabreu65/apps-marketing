...
export function HeroSection() {
  ...
  return (
    <section className="hero-cosmic-bg relative overflow-hidden border-b border-[var(--border-subtle)] py-12 sm:py-16">
      ...
      <Container className="relative z-10">
        <div className="grid gap-6 lg:grid-cols-[1fr_0.9fr] lg:items-center">
          <div className="space-y-4 sm:space-y-5">
            ...
            <h1 className="text-balance text-3xl font-semibold tracking-tight text-[var(--text-primary)] sm:text-5xl lg:text-6xl">
            ...
            <div className="flex flex-wrap gap-2.5">
              ...
              <Button href="#soluciones" variant="secondary" className="rounded-xl px-4 py-3 opacity-90">
                Ver servicios
              </Button>
            </div>
            ...
            <div className="flex flex-wrap gap-2 pt-1">
              ...
              <span className="hidden rounded-full border border-[var(--border-subtle)] bg-[var(--bg-ink)]/70 px-2.5 py-1 text-[11px] text-[var(--text-soft)] sm:inline-flex">
                Asistente comercial con IA
              </span>
            </div>
          </div>

          <article className="glass-card hidden rounded-3xl p-5 sm:p-6 lg:block">
