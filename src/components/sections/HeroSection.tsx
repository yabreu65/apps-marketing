      ...
      <Container className="relative z-10 max-w-[1440px] top-16 sm:top-32">
        <div className="grid place-items-center gap-6">
          <div className="space-y-4 text-center sm:space-y-5">
            <h1 className="mx-auto max-w-[800px]  text-3xl font-semibold leading-[1.35] tracking-normal text-[var(--text-primary)] sm:text-4xl md:text-5xl  lg:text-6xl">
              Creamos webs y sistemas con IA para captar, ordenar y convertir mejor tus consultas.
            </h1>

            <p className="mx-auto max-w-2xl text-base leading-6 text-[var(--text-secondary)] sm:text-2xl">
