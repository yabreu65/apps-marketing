    ...
    <section className="border-b border-[#26324A] bg-[#111827] py-16 sm:py-20">
      <Container className="space-y-8">
        <SectionHeading
          ...
          description="Mostramos cómo una operación comercial evoluciona desde captura de leads hasta seguimiento estructurado en un entorno web moderno."
        />

        <div className="grid gap-4 lg:grid-cols-3">
          <article className="rounded-2xl border border-[#26324A] bg-[#0B1020] p-4 lg:col-span-2">
            <div className="mb-4 flex items-center justify-between">
              <p className="text-sm font-semibold text-[#FFFBF5]">Lead Operations View</p>
              <span className="rounded-full border border-[#7C3AED]/40 bg-[#7C3AED]/15 px-2 py-1 text-[10px] uppercase tracking-wider text-[#C4B5FD]">Mock UI</span>
            </div>
