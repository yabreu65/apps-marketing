...
export function SolutionSection() {
  return (
    <section className="section-violet-depth relative overflow-hidden border-b border-[var(--border-subtle)] py-16 sm:py-20">
      <div className="pointer-events-none absolute left-1/3 top-0 h-40 w-40 sm:h-64 sm:w-64 rounded-full bg-[var(--purple-soft)]/12 blur-2xl sm:blur-3xl" />
      <div className="pointer-events-none absolute -right-20 bottom-8 h-44 w-44 sm:h-72 sm:w-72 rounded-full bg-[var(--purple-primary)]/18 blur-2xl sm:blur-3xl" />
        ...
        <div className="grid gap-4 md:grid-cols-3">
          {pillars.map((pillar) => (
            <Card key={pillar.title}>
              <div className="mb-4 h-9 w-9 rounded-2xl border border-[var(--purple-primary)]/40 bg-[var(--purple-primary)]/16 shadow-[0_0_24px_rgba(124,58,237,0.25)]" />
              <h3 className="text-lg font-semibold text-[var(--warm-white)]">{pillar.title}</h3>
